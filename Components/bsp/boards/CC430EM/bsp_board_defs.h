 ...
 */
  ...
  #define BSP_TIMER_A0 0x4130 // 'A' and '0' characters in hex
  #define BSP_TIMER_A1 0x4131 // 'A' and '1' characters in hex

  #ifndef BSP_TIMER_USED
    #define BSP_TIMER_USED BSP_TIMER_A0
  #else // if BSP_TIMER_USED was user defined
    #if BSP_TIMER_USED != BSP_TIMER_A0 && BSP_TIMER_USED != BSP_TIMER_A1
      #error "ERROR: The selected timer is invalid, must be BSP_TIMER_A0 or BSP_TIMER_A1."
    #endif
  #endif
  /* Timer A0 and Timer A1 are similar enough in operation that either one can be used
  ...
  #if BSP_TIMER_USED == BSP_TIMER_A0
    #define BSP_TIMER_VECTOR TIMER0_A0_VECTOR
    #define TxCTL   TA0CTL
    #define TxR     TA0R
    #define TxCCR0  TA0CCR0
    #define TxCCTL0 TA0CCTL0
  #elif BSP_TIMER_USED == BSP_TIMER_A1
    #define BSP_TIMER_VECTOR TIMER1_A0_VECTOR
    #define TxCTL   TA1CTL
    #define TxR     TA1R
    #define TxCCR0  TA1CCR0
    #define TxCCTL0 TA1CCTL0
  #endif
...
#define BSP_InitBoard( )
#define BSP_DELAY_USECS(x)        MRFI_DelayUsec(x)
