 ...
 * ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
 */
#define __bsp_LED_VDD_SW_CTRL_BIT__   2
#define __bsp_LED_VDD_SW_CTRL_PORT__  P1
#define __bsp_LED_VDD_SW_CTRL_DDR__   P1DIR

/* enable software controlled VDD */
#define __bsp_LED_EXTENDED_CONFIG__()  st( __bsp_LED_VDD_SW_CTRL_DDR__  |=  BV( __bsp_LED_VDD_SW_CTRL_BIT__ ); \
                                           __bsp_LED_VDD_SW_CTRL_PORT__ &= ~BV( __bsp_LED_VDD_SW_CTRL_BIT__ ); )
